    ...
    <div class="container containerLogout">
        ...
        <div class="row"> 
            <div class="well col-lg-offset-2 col-lg-8">
                ...
                Si ne n'est pas le cas, vous pouvez quitter cette page ou cliquez sur ce lien : <br/><a href="loginView.php" class="red" title="lien qui redirige vers la page de connexion">Page de connexion</a></p>
            </div>
        </div>
    </div>
<?php
