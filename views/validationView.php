...
<div class="container containerValidateCount">
    <div class="row">
        <h2 class="text-center alert-info"><?= !empty($error['confirmed']) ? $error['confirmed'] : 'Compte activé'; ?></h2>
    </div>
    <?php if (!isset($error['confirmed'])) { ?>
        <div class="row well well-info h4">
            <p>Félicitation  votre compte est activé et vous pouvez dès à présent vous connecter. <br/>
